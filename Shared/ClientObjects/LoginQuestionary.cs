...
namespace SharedClass.ClientObjects
{
	public class LoginQuestionary
	{
		...
		[Required, RegularExpression("^[!-~ęóąśłżźćńĘÓĄŚŁŻŹĆŃ]{8,30}$", ErrorMessage = "Password contains illegal char!"), StringLength(60, MinimumLength = 8, ErrorMessage = "Password is too short or too long")]
